...
internal class BybitLendingLoanOrderContainer
{
    ...
    public List<BybitLendingLoanOrder> Payload { get; set; } = [];
}
...
public class BybitLendingLoanOrder
{
    ...
    public List<BybitLendingProductLeverage> USDTPerpetualLeverage { get; set; } = [];
    ...
    public List<BybitLendingProductLeverage> USDCContractLeverage { get; set; } = [];
}