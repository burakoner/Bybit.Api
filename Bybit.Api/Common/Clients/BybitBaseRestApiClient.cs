...
internal class BybitBaseRestApiClient : RestApiClient
{
    // Internal
    internal ILogger Log { get => _logger; }
    ...
    internal BybitBaseRestApiClient(BybitRestApiClient root) : base(root.Logger, root.ClientOptions)
    {
        _ = root;
    ...
    protected override TimeSyncInfo GetTimeSyncInfo() => new(_logger, ClientOptions.AutoTimestamp, ClientOptions.TimestampRecalculationInterval, TimeSyncState);
